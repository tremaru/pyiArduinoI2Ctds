...
#define         REG_TDS_Rd              0x11                                                                    //  Адрес регистра содержащего сопротивление датчика «Rd» в тысячных долях Ом (три байта).
#define         REG_TDS_Kd              0x14                                                                    //  Адрес регистра содержащего постоянную датчика «Кd» в тысячных долях см^-1 (два байта).
...
#define         REG_TDS_S               0x1E                                                                    //  Адрес регистра содержащего удельную электропроводность «S» в мкСм/см измеренную при текущей температуре t°C (два байта).
#define         REG_TDS_EC              0x20                                                                    //  Адрес регистра содержащего удельную электропроводность «EC» в мкСм/см приведённую к опорной температуре T°С (два байта).
#define         REG_TDS_TDS             0x22                                                                    //  Адрес регистра содержащего количество растворенных в воде примесей «TDS» в ppm = мг/л (два байта).
//              Позиция битов и флагов:                                                                         //
#define         TDS_BIT_CALC_Kd_2       0x08                                                                    //  Бит   регистра REG_TDS_CALIBRATION указывает модулю выполнить 2 стадию калибровки.
#define         TDS_BIT_CALC_Kd_1       0x04                                                                    //  Бит   регистра REG_TDS_CALIBRATION указывает модулю выполнить 1 стадию калибровки.
#define         TDS_BIT_CALC_Kt_2       0x02                                                                    //  Бит   регистра REG_TDS_CALIBRATION указывает модулю выполнить 2 стадию определения температурного коэффициента.
#define         TDS_BIT_CALC_Kt_1       0x01                                                                    //  Бит   регистра REG_TDS_CALIBRATION указывает модулю выполнить 1 стадию определения температурного коэффициента.
                                                                                                                //
class iarduino_I2C_TDS{                                                                                         //
    ...
    /** Пользовательские функции **/                                                                            //
        ...
        float               getRd               (void               );                                          //  Объявляем  функцию получения    общего сопротивления датчика            (Параметр:  отсутствует).
        bool                setRd               (float              );                                          //  Объявляем  функцию установки    общего сопротивления датчика            (Параметр:  сопротивление от 0 до ±8'388.607 Ом).
        float               getKd               (void               );                                          //  Объявляем  функцию получения    постоянной датчика                      (Параметр:  отсутствует).
        bool                setKd               (float              );                                          //  Объявляем  функцию установки    постоянной датчика                      (Параметр:  постоянная датчика от 0 до 65,535 см^-1).
